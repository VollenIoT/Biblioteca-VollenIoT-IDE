...
//
// IMPORTANTE: Para que a conexao de multiplos ESPs com o mesmo ID seja
// aceita, o modo desenvolvedor deve ser ativo com vollen.setDeveloperMode(true).
// Caso contrario, o ESP sera desconectado se houver duplicidade.
// =============================================================================
...
// ─── ID do dispositivo (MESMO ID in todos os ESPs que compartilham o rele) ──
const char* MeuRele = "painel-sala-1";
...
void setupDevices() {
    ...
    // Habilita o modo desenvolvedor para permitir conexoes duplicadas/multi-device
    vollen.setDeveloperMode(true);
}
